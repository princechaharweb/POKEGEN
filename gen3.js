// gen3.js — loads Gen III Pokemon (252-386) from PokéAPI and renders cards

const START_ID = 252;  // Treecko
const END_ID = 386;    // Deoxys
...
// Add batch loading with intersection observer for better performance
